...
tests.add("insert:21_formatting_insert_final_eol", "success", () => JSONC.insert_into_file(
    `{ "a": 1 }`.dedent(),
    { "a": 2 },
    { update: false, insert_final_eol: true }
));
...
tests.add("insert:23_empty_file_content_replaced", "success", () => JSONC.insert_into_file(
    ``.dedent(),
    { "a": 1 },
    { update: false }
));
...
tests.add("insert:24_empty_file_content_root_array", "success", () => JSONC.insert_into_file(
    ``.dedent(),
    [{ "a": 1 }, { "b": 2 }],
    { update: false }
));
