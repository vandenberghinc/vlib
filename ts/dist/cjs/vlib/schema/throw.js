...
var import_index_web = require("../index.web.js");
function value_type(value) {
  if (value === null) {
    ...
    return "array";
  } else if (typeof value === "object" && import_index_web.ObjectUtils.is_plain(value)) {
...
function primitive_array_type(arr) {
  ...
  return arr.every((item) => typeof item === type) ? type : void 0;
}
