 ...
 * @docs
 */
export async function request({ host, port = null, endpoint = "/", method = "GET", headers = {}, params = undefined, compress = false, 
// decompress = true,
query = true, json = false, reject_unauthorized = true, delay = null, http2: use_http2 = false, }) {
