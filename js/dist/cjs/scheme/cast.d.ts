 ...
 */
export type Cast<T extends never | undefined | Cast.Castable | Cast.Value, Def extends any = string, // returned type for undefined | null
Never extends any = string> = [
    T
] extends [never] ? Never : T extends null | undefined ? Def : T extends Function ? T : T extends Cast.Type[] ? Cast.Types[T[number]] : T extends Cast.Type ? Cast.Types[T] : never;
/** Cast types. */
export declare namespace Cast {
    ...
    type Castable = Castable.Base | Castable.Base[];
    namespace Castable {
     ...
     * @libris
     */
    function boolean(str: string, opts: boolean.Opts<"strict">): boolean;
    function boolean(str: string, opts: boolean.Opts<"preserve">): string | boolean;
    function boolean(str: string, opts?: boolean.Opts<"default">): boolean | undefined;
    namespace boolean {
        type Opts<M extends "preserve" | "strict" | "default" = "preserve" | "strict" | "default"> = M extends "preserve" ? {
            preserve: true;
            strict?: false;
        } : M extends "strict" ? {
            preserve?: false;
    ...
    function number(str: string, opts?: number.Opts<"no_preserve">): number | undefined;
    namespace number {
        type Opts<M extends "preserve" | "no_preserve" = "preserve" | "no_preserve"> = M extends "preserve" ? {
            preserve: true;
            strict?: boolean;
        } : {
            preserve?: false;
