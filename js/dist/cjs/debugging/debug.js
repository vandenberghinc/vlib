...
class Debug extends import_callable.Callable {
   ...
   */
  call(log_level, ...args) {
    this.pipe.log(this.level, import_directives.Directive.debug, new import_source_loc.SourceLoc(1), log_level, ...args);
  }
  /**
   ...
   */
  raw(level, ...args) {
    import_pipe.pipe.raw(this.level, import_directives.Directive.debug, import_directives.Directive.raw, new import_source_loc.SourceLoc(1), level, ...args);
  }
  dump(level, ...args) {
    import_pipe.pipe.raw(this.level, import_directives.Directive.debug, import_directives.Directive.raw, new import_source_loc.SourceLoc(1), level, ...args);
  }
