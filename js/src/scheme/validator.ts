...
export class Validator<
    ...
    O extends object = T,
    // /**
    //  * Response mode, either the raw object is the output, or an info object
            ...
            case "array": {
                ...
                if (scheme_item.scheme || scheme_item.value_scheme) {
                    const validator = new Validator("array", {
                        ...
                        tuple: scheme_item.tuple as any,
                        strict: this.strict,
            ...
            case "object": {
                ...
                if (scheme_item.scheme || scheme_item.value_scheme) {
                    const validator = new Validator("object", {
                        scheme: scheme_item.scheme as any,
                        value_scheme: scheme_item.value_scheme as any,
                        tuple: scheme_item.tuple as any,
                        strict: this.strict,
                        parent: `${this.parent}${obj_key}.`,
                        error_prefix: this.error_prefix,
